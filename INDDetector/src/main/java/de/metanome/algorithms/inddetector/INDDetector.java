...
public class INDDetector extends INDDetectorAlgorithm 				// Separating the algorithm implementation and the Metanome interface implementation is good practice
	...
	public String getDescription() {
		return "Searches for INDs."; // A string briefly describing what this algorithm does
	}
	...
	public ArrayList<ConfigurationRequirement<?>> getConfigurationRequirements() { // Tells Metanome which and how many parameters the algorithm needs
		...
		//conf.add(new ConfigurationRequirementRelationalInput(INDDetector.Identifier.INPUT_GENERATOR.name()));
		conf.add(new ConfigurationRequirementRelationalInput(INDDetector.Identifier.INPUT_GENERATOR.name(), ConfigurationRequirement.ARBITRARY_NUMBER_OF_VALUES)); // An algorithm can ask for more than one input; this is typical for IND detection algorithms
	...
	public void setRelationalInputConfigurationValue(String identifier, RelationalInputGenerator... values) throws AlgorithmConfigurationException {
		...
		if (!INDDetector.Identifier.INPUT_GENERATOR.name().equals(identifier))
